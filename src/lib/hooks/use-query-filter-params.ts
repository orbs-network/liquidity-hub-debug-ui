  ...
  const [query, setQuery] = useQueryParams(
    {
      ...
      [URL_QUERY_KEYS.TX_HASH]: ArrayParam,
  ...
  return useMemo(() => {
    return {
      query: {
        ...
        [URL_QUERY_KEYS.USER]: query[URL_QUERY_KEYS.USER] as
          | string[]
          | undefined,
        [URL_QUERY_KEYS.TX_HASH]: query[URL_QUERY_KEYS.TX_HASH] as
          | string[]
          | undefined,
        [URL_QUERY_KEYS.ORDER_ID]: query[URL_QUERY_KEYS.ORDER_ID] as
          | string[]
          | undefined,
